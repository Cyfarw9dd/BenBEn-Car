...
//变量声明
extern unsigned char adc_value[4];  
extern int16 AD_V[4]; 
extern unsigned char adc_max[4];  
extern unsigned char adc_min[4];  
extern unsigned char Left_Adc,Right_Adc,Left_Shu_Adc,Right_Shu_Adc;
extern int8 NM;          
extern unsigned short annulus_s;         
extern unsigned short annulus_t;
extern unsigned short annulus_z;     
extern float Current_Dir;         
extern unsigned char flag_obstacle;
extern unsigned short obstacle_time;
