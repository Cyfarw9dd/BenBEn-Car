...
// unsigned char adc_max[4]={190,150,150,190}; //电感采值最大值 需要自己采集
// unsigned char adc_min[4]={1,1,8,1};        //电感采值最小值
...
// /***************************中值滤波函数*********************************
// 函数：unsigned short adc_mid(ADCN_enum adcn,ADCCH_enum ch)  
// 功能： 3次电感采值进行中值滤波
...
// 作者：  heqiu 
// ************************************************************************/
// unsigned short adc_mid(ADCN_enum adcn,ADCRES_enum ch)
// {
...
// /***************************均值滤波函数****************************
// 函数：  unsigned short adc_ave(ADCN_enum adcn,ADCCH_enum ch,unsigned char N) 
// 功能：  中值滤波后的5个电感值求平均值
// 参数：  adcn        选择ADC通道         
...
// *******************************************************************/
// unsigned short adc_ave(ADCN_enum adcn,ADCRES_enum ch,unsigned char N)
// {
